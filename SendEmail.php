...
// $.post("SendEmail.php", {a_from: from_str, a_subject: subject_str, a_msg: msg_str, a_to: to_str, a_cc: cc_str},function(data,status){alert(data);});
//
...
// "SendEmail.php": URL parameter specifies the URL you wish to request
...
// More headers
$headers .= 'From: <reservation@jazzliveaarau.ch>' . "\r\n";
$headers .= 'BCC: ';
$headers .= $address_bcc;
$headers .=  "\r\n";
